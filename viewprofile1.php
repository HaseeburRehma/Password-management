...
// Retrieve empid from URL parameter
if (isset($_GET['id'])) {
    $empid = $_GET['id'];

    // Query to fetch employee data based on empid
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-6 ">
                                                                        <div class="work-info">
                                                                            ...
                                                                            <div class="info-item">
                                                                                <span class="info-label">Bank Account
                                                                                </span>
                                                                                <span
                                                                                    class="info-value"><?php echo $employee['accountnumber']; ?></span>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-md-6 ">
                                                                        <div class="attachments-info">
                                                                            ...
                                                                            <p>
                                                                                <?php
                                                                                // Function to generate thumbnails for PDFs using Imagick
                                                                                function generateThumbnailPDF($pdfPath)
                                                                                {
                                                                                    ...
                                                                                    try {
                                                                                        ...
                                                                                        // Set the thumbnail size (width x height)
                                                                                        $imagick->thumbnailImage(200, 0); // 200px wide, proportional height
                                                                                ...
                                                                                // Example usage assuming $employee array contains 'resume' key
                                                                                if (!empty($employee['resume'])) {
                                                                                    $pdfPath = $employee['resume'];
                                                                                    $thumbnailPath = generateThumbnailPDF($pdfPath);

                                                                                    if ($thumbnailPath) {
                                                                                        $documentName = basename($pdfPath);
                                                                                        echo "<a href=\"$pdfPath\" target=\"_blank\"><img src=\"$thumbnailPath\" alt=\"$documentName\"></a>";
                                                                                        echo "<br><a href=\"$pdfPath\" target=\"_blank\">$documentName</a>";
                                                                                    } else {
                                                                                        echo "Thumbnail generation failed for: $pdfPath";
                                                                                    }
                                                                                } else {
                                                                                    echo "No resume attachment found.";
                                                                                }
                                                                                ?>
                                                                            ...
                                                                            <p>
                                                                                ...
                                                                                function generateThumbnail($filePath)
                                                                                {
                                                                                    ...
                                                                                    try {
                                                                                        ...
                                                                                        // Save thumbnail to the thumbnails directory
                                                                                        $thumbnailPath = 'thumbnails/' . basename($filePath, '.pdf') . '.jpg';
                                                                                        $imagick->writeImage($thumbnailPath);
                                                                                ...
                                                                                // Assuming $employee array is defined and contains 'cnic' key
                                                                                if (!empty($employee['cnic'])) {
                                                                                    // Use the CNIC path stored in the column
                                                                                    $cnicPath = $employee['cnic'];

                                                                                    // Generate thumbnail for CNIC document
                                                                                    $thumbnailPath = generateThumbnail($cnicPath);

                                                                                    if ($thumbnailPath) {
                                                                                        $documentName = basename($cnicPath);
                                                                                        echo "<a href=\"$cnicPath\" target=\"_blank\"><img src=\"$thumbnailPath\" alt=\"$documentName\"></a>";
                                                                                        echo "<br><a href=\"$cnicPath\" target=\"_blank\">$documentName</a>";
                                                                                    } else {
                                                                                        echo "Thumbnail generation failed for: $cnicPath";
                                                                                    }
                                                                                } else {
                                                                                    echo "No CNIC attachment found.";
                                                                                }
                                                                                ?>
                                                                            </p>
