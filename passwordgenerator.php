            ...
            <div class="card card-info text-center font-weight-bold">
              ...
              <div class="card-body"
                ...
                <ul class="list-group list-group-flush">
                    ...
                    <div class="row">
                      ...
                      <div class="col-6">
                        ...
                        <div class="custom-control custom-switch">
                          <input type="checkbox" class="custom-control-input" id="uppercase" checked disabled>
                  ...
                  <li class="list-group-item">
                    <div class="row">
                      ...
                      <div class="col-12 col-sm-6">
                        <!-- <div class="form-check"> -->
                        <div class="custom-control custom-switch">
                          <input type="checkbox" class="custom-control-input" id="number_id" checked disabled>
                  ...
                  <li class="list-group-item">
                    <div class="row">
                      ...
                      <div class="col-12 col-sm-6">
                        <!-- <div class="form-check"> -->
                        <div class="custom-control custom-switch">
                          <input type="checkbox" class="custom-control-input" id="char_id" checked disabled>
                    ...
                    <div class="row">
                      ...
                      <div class="col-12 col-sm-6">
                        ...
                        <div class="form-group">
                          ...
                          <input type="number" class="form-control" value="16" id="lenght" name="lenght"
                            placeholder="Lenght">
                        </div>
                      </div>
                  ...
                  <li class="list-group-item">
                    <div class="row">
                      ...
                      <div class="col-12 col-sm-6">
                        <div class="form-group">
                          <input type="number" class="form-control" value="15" id="passwords" placeholder="passwords">
                        </div>
                      </div>
                    </div>
                  </li>
                ...
                <div class="card-footer text-muted text-center">
                  <button id="redirect" type="button" class="btn btn-success" onclick="makeid()">Click to Generate
                    Number</button>
                </div>
              </div>
            </div>
