      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <div class="container-fluid">
            <div class="row mb-2">
              <div class="col-sm-6">
                <h5><i class="nav-icon fas fa-user-cog"></i> Used Tool Code</h5>
              </div>
              <div class="col-sm-6">
          ...
          <div class="container-fluid">
            ...
            <div class="row">
              <div class="col-md-12 mb-2">
                <a href="availableclientcode.php" class="btn btn-success float-right pr-3"><i
                    class="fas fa-wallet mr-1"></i>Avilable Code</a>
              </div>
              <div class="col-md-12 ">

                <div class="card ">
                  <div class="card-header bg-info">
                    <h3 class="card-title">Used Tool Code</h3>
                  ...
                  <div class="card-body">
                    <?php
                    // $sql = "SELECT * FROM `carname` as mv where (select count(*) from getcar where tool_id= mv.c_id) != 0";
                    $sql = "SELECT cn.*, gt.tool_owner
        FROM `carname` AS cn
        INNER JOIN `getcar` AS gt ON cn.c_id = gt.tool_id
        WHERE (SELECT COUNT(*) FROM `getcar` WHERE tool_id = cn.c_id) != 0";
